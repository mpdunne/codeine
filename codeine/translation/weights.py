...
class CodonWeights:
    ...
    def ecoli(cls, rna: Optional[bool] = None) -> 'CodonWeights':
        ...
        """
        from translation.data.weights import ECOLI_WEIGHTS
    ...
    def yeast(cls, rna: Optional[bool] = None) -> 'CodonWeights':
        ...
        """
        from translation.data.weights import YEAST_WEIGHTS
    ...
    def human(cls, rna: Optional[bool] = None) -> 'CodonWeights':
        ...
        """
        from translation.data.weights import HUMAN_WEIGHTS
    ...
    def mouse(cls, rna: Optional[bool] = None) -> 'CodonWeights':
        ...
        """
        from translation.data.weights import MOUSE_WEIGHTS
    ...
    def arabidopsis(cls, rna: Optional[bool] = None) -> 'CodonWeights':
        ...
        """
        from translation.data.weights import ARABIDOPSIS_WEIGHTS
    ...
    def drosophila(cls, rna: Optional[bool] = None) -> 'CodonWeights':
        ...
        """
        from translation.data.weights import DROSOPHILA_WEIGHTS
